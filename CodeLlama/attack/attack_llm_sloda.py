...
from llm_attacker import SLODA_Attacker
...
def main():
    ...
    attacker = SLODA_Attacker(args, model, tokenizer)
    ...
    for index, example in enumerate(eval_data):
        if 1000 <= index < 1500:
            ...
            #print("query_times1",query_times1)
            if is_success == 1:
            ...
            query_times = query_times2 + query_times1
            if not is_success == 1:
